...
| Stage 3 | Free Trial Booked | Calendly booking confirmed | Email 1 (immediate), Email 2 (24hr before), Email 3 (morning of) |
| Stage 3 | No Show | Nate manually moves after class ends with no attendance | Email 4 |
| Stage 4 | Trial Attended | Nate manually moves after confirmed attendance | No email — await Stage 5 or 6 |
| Stage 5 | Decision Pending | 48hrs in Stage 4 with no movement | Email 5 |
| Stage 6 | Needs Time | Nate manually moves when prospect says they need time | Email 6 |
| Stage 7 | Signed Up | Nate manually moves when membership confirmed | Triggers onboarding sequence (separate system) |
| Stage 8 | Long-Term Nurture | No-show or cancellation with no re-engagement after window | General nurture sequence |
...
| 4 | No-Show Recovery | Nate moves to No Show stage | End of trial day | Under 120 |
...
If no rebook in 30 days → move to Stage 8 (Long-Term Nurture).

**On no-show (Email 4):**
One email only.
If no response or rebook in 7 days → move to Stage 8.
