...
- Keep the CTA general: "Schedule Your Free Trial"
...
| CTAs | Segment-specific calls to action | Every conversion-oriented piece |
...
- [ ] CTA matches segment — not a generic "learn more"
...
- V1.0 — 2026-03-29 — Initial build. Replaces etkm-audience-map, etkm-messaging-playbook, etkm-problem-solution, etkm-story-arcs. All audience data migrated to ETKM Audience Segments database in Notion (14 records, 19 fields each). Skill contains routing logic, decision rules, and quality gates only.
